...
public class AddressBookManager {
    ...
    public AddressBookManager() {
        ...
        books = new HashMap<String, AddressBook>(); //Implement to create books HashMap
    ...
    public void add(String name, String phone) {
        ...
        books.put(name,book);        //Implement to create AddressBook and add into books
    ...
    public AddressBook remove(String name) {
        ...
        book = books.remove(name); //Implement to remove AddressBook that has name as key
    ...
    public void printAll() {
        ...
        for(String key:books.keySet()){
            ...
            System.out.println(books.get(key)); //Implement to printAll AddressBook
